...
class _$TaskModelImpl extends _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskModel(id: $id, title: $title, description: $description, deadline: $deadline, isCompleted: $isCompleted, createdAt: $createdAt, updatedAt: $updatedAt, reminderMinutes: $reminderMinutes, priority: $priority)';
  }
